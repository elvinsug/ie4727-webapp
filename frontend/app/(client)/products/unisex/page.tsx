...
const ShoeTypes = [
	...
	{
		name: "Casual",
		path: "/products/unisex?type=casual",
		icon: `${BASE_PATH}/shoes-icon/casual.svg`,
	},
	{
		name: "Track & Field",
		path: "/products/unisex?type=track_field",
		icon: `${BASE_PATH}/shoes-icon/track_field.svg`,
	},
	{
		name: "Arch",
		path: "/products/unisex?type=arch",
...
const AvailableSizes = [
	...
	{
		name: "36",
		path: "/products/unisex?size=36",
	},
	{
		name: "37",
		path: "/products/unisex?size=37",
	},
	{
		name: "38",
		path: "/products/unisex?size=38",
	},
	{
		name: "39",
		path: "/products/unisex?size=39",
	},
	{
		name: "40",
		path: "/products/unisex?size=40",
	},
	{
		name: "41",
		path: "/products/unisex?size=41",
	},
	{
		name: "42",
		path: "/products/unisex?size=42",
	},
	{
		name: "43",
		path: "/products/unisex?size=43",
	},
	{
		name: "44",
		path: "/products/unisex?size=44",
	},
	{
		name: "45",
		path: "/products/unisex?size=45",
	},
];

const API_URL = process.env.NEXT_PUBLIC_API_URL || "http://localhost/miona/api";

const UnisexProductsPageContent = () => {
	...
	const fetchProducts = async () => {
		...
		try {
			...
			// Always filter by unisex
			params.set("sex", "unisex");
			...
			const response = await fetch(
				`${API_URL}/products/get_products_colors.php?${params.toString()}`
			);
	...
	return (
		<div className="mt-[88px] w-screen p-8 pt-4">
			<header className="flex flex-col gap-2">
				...
				{/* Page Title */}
				<h1 className="text-3xl font-bold">Unisex Sneakers</h1>
