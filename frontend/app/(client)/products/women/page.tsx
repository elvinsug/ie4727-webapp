...
const ShoeTypes = [
	...
	{
		name: "Casual",
		path: "/products/women?type=casual",
		icon: `${BASE_PATH}/shoes-icon/casual.svg`,
	},
	{
		name: "Track & Field",
		path: "/products/women?type=track_field",
		icon: `${BASE_PATH}/shoes-icon/track_field.svg`,
	},
	{
		name: "Arch",
		path: "/products/women?type=arch",
...
const AvailableSizes = [
	...
	{
		name: "36",
		path: "/products/women?size=36",
	},
	{
		name: "37",
		path: "/products/women?size=37",
	},
	{
		name: "38",
		path: "/products/women?size=38",
	},
	{
		name: "39",
		path: "/products/women?size=39",
	},
	{
		name: "40",
		path: "/products/women?size=40",
	},
	{
		name: "41",
		path: "/products/women?size=41",
	},
	{
		name: "42",
		path: "/products/women?size=42",
	},
	{
		name: "43",
		path: "/products/women?size=43",
	},
	{
		name: "44",
		path: "/products/women?size=44",
	},
	{
		name: "45",
		path: "/products/women?size=45",
	},
];

const API_URL = process.env.NEXT_PUBLIC_API_URL || "http://localhost/miona/api";

const WomenProductsPageContent = () => {
	...
	return (
		<div className="mt-[88px] w-screen p-8 pt-4">
			<header className="flex flex-col gap-2">
				...
				{/* Page Title */}
				<h1 className="text-3xl font-bold">Sneakers for Women</h1>
